...
#define LOG_INFO(...) __android_log_print(ANDROID_LOG_INFO, "android_client_ndk", __VA_ARGS__)
...
Java_com_example_adroidclient_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_com_example_adroidclient_MainActivity_randomBytes(JNIEnv *env, jclass clazz, jint no) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_adroidclient_MainActivity_encrypt(JNIEnv *env, jclass clazz,jbyteArray key, jbyteArray data) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_adroidclient_MainActivity_decrypt(JNIEnv *env, jclass clazz,jbyteArray key, jbyteArray data) {
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
